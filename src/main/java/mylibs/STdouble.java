...
public class STdouble<Value>
{
    ...
    public STdouble clone()
    {
        STdouble ret = new STdouble();
        ret.root = clone(this.root);
        return ret;
    }

    // Checks if two trees are equal
    public boolean equals(STdouble tree) {return equals(this.root, tree.root);}
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        if(test)
        {
            ...
            String retStr;
            Integer sz;
            STdouble<String> st = new STdouble <String>();
            String pf = "fail";
            ...
            pf = "fail"; retStr = st.get(30.398); if(retStr == null) pf = "pass"; System.out.println("    " + pf + " - get(30.398): " + retStr);
            ...
            pf = "fail"; st.put(30.398, "A"); if(st.toString().equals(st.toString())) pf = "pass"; System.out.println("    " + pf + " - put(30.398, A): " + st.toString());
            ...
            pf = "fail"; retStr = st.get(30.398); if(retStr == "A") pf = "pass"; System.out.println("    " + pf + " - get(30.398): " + retStr);
            ...
            pf = "fail"; st.put(10.046, "B"); retStr = st.toString(); if(retStr.equals("(10.046, B), (30.398, A)")) pf = "pass"; System.out.println("    " + pf + " - put(10.046, B): " + retStr);
            ...
            pf = "fail"; ret = st.height23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; st.put(45.454, "C"); retStr = st.toString(); if(retStr.equals("(30.398, A), (45.454, C)")) pf = "pass"; System.out.println("    " + pf + " - put(45.454, C): " + retStr);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; ret = st.height(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; st.put(10.046, "B"); retStr = st.toString(); if(retStr.equals("(10.046, B), (30.398, A), (45.454, C)")) pf = "pass"; System.out.println("    " + pf + " - put(10.046, B): " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            ...
            pf = "fail"; ret = st.heightCompute23(); if(ret == 0) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 0) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(30.398, "A"); retStr = st.toString(); if(retStr.equals("(30.398, A)")) pf = "pass"; System.out.println("    " + pf + " - put(30.398, A): " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            ...
            pf = "fail"; st.put(30.398, "A"); retStr = st.toString(); if(retStr.equals("(30.398, A)")) pf = "pass"; System.out.println("    " + pf + " - put(30.398, A), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(45.454, "B"); retStr = st.toString(); if(retStr.equals("(30.398, A), (45.454, B)")) pf = "pass"; System.out.println("    " + pf + " - put(45.454, B), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 1) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(10.046, "C"); retStr = st.toString(); if(retStr.equals("(10.046, C), (30.398, A), (45.454, B)")) pf = "pass"; System.out.println("    " + pf + " - put(10.046, C), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(15.983, "D"); retStr = st.toString(); if(retStr.equals("(10.046, C), (15.983, D), (30.398, A), (45.454, B)")) pf = "pass"; System.out.println("    " + pf + " - put(15.983, D), size() = " + st.size() + ": " + retStr);
            ...
            pf = "fail"; ret = st.heightCompute23(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(25.501, "E"); retStr = st.toString(); if(retStr.equals("(10.046, C), (15.983, D), (25.501, E), (30.398, A), (45.454, B)")) pf = "pass"; System.out.println("    " + pf + " - put(25.501, E), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(35.556, "F"); retStr = st.toString(); if(retStr.equals("(10.046, C), (15.983, D), (25.501, E), (30.398, A), (35.556, F), (45.454, B)")) pf = "pass"; System.out.println("    " + pf + " - put(35.556, F), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 2) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(60.333, "G"); retStr = st.toString(); if(retStr.equals("(10.046, C), (15.983, D), (25.501, E), (30.398, A), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(60.333, G), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            ...
            pf = "fail"; st.put(5.192, "H"); retStr = st.toString(); if(retStr.equals("(5.192, H), (10.046, C), (15.983, D), (25.501, E), (30.398, A), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(5.192, H), size() = " + st.size() + ": " + retStr);
            ...
            pf = "fail"; ret = st.heightCompute23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(13.267, "I"); retStr = st.toString(); if(retStr.equals("(5.192, H), (10.046, C), (13.267, I), (15.983, D), (25.501, E), (30.398, A), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(13.267, I), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 4) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 4) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(3.002, "J"); retStr = st.toString(); if(retStr.equals("(3.002, J), (5.192, H), (10.046, C), (13.267, I), (15.983, D), (25.501, E), (30.398, A), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(3.002, J), size() = " + st.size() + ": " + retStr);
            ...
            pf = "fail"; ret = st.heightCompute23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(11.742, "K"); retStr = st.toString(); if(retStr.equals("(3.002, J), (5.192, H), (10.046, C), (11.742, K), (13.267, I), (15.983, D), (25.501, E), (30.398, A), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(11.742, K), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(20.773, "L"); retStr = st.toString(); if(retStr.equals("(3.002, J), (5.192, H), (10.046, C), (11.742, K), (13.267, I), (15.983, D), (20.773, L), (25.501, E), (30.398, A), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(20.773, L), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(27.277, "M"); retStr = st.toString(); if(retStr.equals("(3.002, J), (5.192, H), (10.046, C), (11.742, K), (13.267, I), (15.983, D), (20.773, L), (25.501, E), (27.277, M), (30.398, A), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(27.277, M), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            pf = "fail"; ret = st.checkBlackBalance(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - checkBlackBalance(): " + ret);
            pf = "fail"; st.put(31.111, "N"); retStr = st.toString(); if(retStr.equals("(3.002, J), (5.192, H), (10.046, C), (11.742, K), (13.267, I), (15.983, D), (20.773, L), (25.501, E), (27.277, M), (30.398, A), (31.111, N), (35.556, F), (45.454, B), (60.333, G)")) pf = "pass"; System.out.println("    " + pf + " - put(31.111, N), size() = " + st.size() + ": " + retStr);
            pf = "fail"; ret = st.height(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - height(): " + ret);
            pf = "fail"; ret = st.heightCompute(); if(ret == 5) pf = "pass"; System.out.println("    " + pf + " - heightCompute(): " + ret);
            pf = "fail"; ret = st.height23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - height23(): " + ret);
            pf = "fail"; ret = st.heightCompute23(); if(ret == 3) pf = "pass"; System.out.println("    " + pf + " - heightCompute23(): " + ret);
            ...
            pf = "fail"; retStr = st.get(30.398); if(retStr.equals("A")) pf = "pass"; System.out.println("    " + pf + " - get(30.398): " + retStr);
            pf = "fail"; retStr = st.get(31.111); if(retStr.equals("N")) pf = "pass"; System.out.println("    " + pf + " - get(31.111): " + retStr);
            pf = "fail"; retStr = st.get(20.773); if(retStr.equals("L")) pf = "pass"; System.out.println("    " + pf + " - get(20.773): " + retStr);
        ...
        else
        {
            ...
            System.out.println("    Key 123 has value " + st.get(123));
            System.out.println("    Key 60 has value " + st.get(60));
            System.out.println("");
